    ...
    return (
        <section className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-base text-muted">AI Engineer, Product Consultant</p>
                <p className="text-sm text-muted">Bangalore, India | San Francisco, CA</p>
            </div>
            ...
            <div className="mb-8">
                        ...
                        <div className="mb-2 sm:mb-0">
                            ...
                            <p className="text-base text-primary font-medium">
                                <Link href="http://ema.co" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                                    ...
                                    <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                                </Link>
                            </p>
                        </div>
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                        <div className="mb-2 sm:mb-0">
                            ...
                            <p className="text-base text-primary font-medium devanagari">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-muted mb-3">Backed by Accel, Together Fund, Techstars, Venture Catalysts, Cornerstone Venture Partners, Chennai Angels, and Astarc Ventures</p>
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                        <div className="mb-2 sm:mb-0">
                            ...
                            <p className="text-base text-primary font-medium"><code>KS2 Labs</code></p>
                        </div>
                        <div className="text-left sm:text-right text-sm text-muted">
                    ...
                    <ul className="text-sm text-ink space-y-1">
                        <li>• Research on RL agents that do not need the perfect board state to play superhuman chess. This would demonstrate that NNs have internal representation capacity to solve complicated problems giving only traces of information.
                            <Link href="https://www.youtube.com/watch?v=Xd0psila1Ug" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-ink hover:text-accent transition-colors">
                        ...
                        <li>• New research directions for weather modelling that uses ground based sensor data instead of solely relying on weather satellites, which causes issues like cold-bias and wrong temperature prediction.
                            <Link href="https://github.com/yashbonde/vaayuvidha" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-ink hover:text-accent transition-colors">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                        <div className="mb-2 sm:mb-0">
                            ...
                            <p className="text-base text-primary font-medium"><code>NPAW, Spain</code></p>
                        </div>
                        <div className="text-left sm:text-right text-sm text-muted">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                        <div className="mb-2 sm:mb-0">
                            ...
                            <p className="text-base text-primary font-medium"><code>Kaaenaat</code></p>
                        </div>
                        <div className="text-left sm:text-right text-sm text-muted">
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/artha" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">artha</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/vriksham" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">vriksham</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/tuneapi/tree/main" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">tuneapi</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/astea" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">astea</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/NimbleBoxAI/ChainFury" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">ChainFury</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/NimbleBoxAI/nbox" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">nbox</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/yQL" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">yQL</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/general-perceivers" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">general-perceivers</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/chess_lm" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">chess_lm</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/dall-e-baby" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">dall-e-baby</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/spyql" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">spyql</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="mb-2">
                        <Link href="https://github.com/yashbonde/vaayuvidha" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:scale-105">
                            <code className="text-lg font-semibold text-primary">vaayuvidha</code>
                            <ArrowUpRight className="w-4 h-4 font-bold text-primary" />
                        </Link>
                    </div>
                ...
                <div className="mb-6">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                        <div className="mb-2 sm:mb-0">
                            ...
                            <p className="text-base text-primary font-medium"><code>National Institute of Technology Raipur</code></p>
                        </div>
                        <div className="text-left sm:text-right text-sm text-muted">
