    ...
    <section className="max-w-3xl mx-auto">
      <div className="mb-16">
        ...
        <div className="flex flex-wrap gap-5 mt-8 text-base">
          <ClickZoom>
            <a className="text-primary font-medium hover:scale-105" href="https://www.linkedin.com/in/yashbonde" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          </ClickZoom>
          <ClickZoom>
            <Link className="text-primary font-medium hover:scale-105" href="/blog">Blogs</Link>
          </ClickZoom>
          <ClickZoom>
            <a className="text-primary font-medium hover:scale-105 devanagari" href="https://artha-pearl.vercel.app" target="_blank" rel="noopener noreferrer">Project <span className="devanagari">अर्थ</span> (Artha)</a>
          </ClickZoom>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-14">
        ...
        <div>
          ...
          <div className="text-sm text-muted">Open to collaborate</div>
        </div>
      </div>
      ...
      <ClickZoom>
        <Link className="inline-block text-primary font-medium text-base hover:scale-105" href="/about">More about me →</Link>
      </ClickZoom>
    </section>
  );
}
