...
const POST_INDEX: { slug: string; url?: string; title: string; date: string; tags: string[]; group?: string }[] = [
    ...
    // 2023
    { slug: "accel-india-talk-2023-youtube", url: "https://www.youtube.com/watch?v=cDOdAUYIJ_k", title: "Accel India Summit (YouTube)", date: "2023-11-03", tags: ["YouTube"] },

    // 2020
    { slug: "chess-ai-youtube", url: "https://www.youtube.com/watch?v=Xd0psila1Ug&list=PLDwlXbwbl9GN4byp44SmqzrRGwHNbUqg3", title: "Chess AI Livestreams (YouTube)", date: "2020-11-30", tags: ["YouTube"] },
    ...
    { slug: "reading-list-neural-graph-execution", title: "Reading List on Neural Graph Execution", date: "2020-05-11", tags: ["Neural Networks", "Neural Automata", "Research", "Notes"] },
    { group: "Barto Sutton Chapter 5-6", slug: "rl/chapter-6-exercises", title: "RL Chapter 6: Exercises", date: "2020-04-27", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 5-6", slug: "rl/chapter-6-temporal-difference-learning", title: "RL Chapter 6: Temporal Difference Learning", date: "2020-04-27", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 5-6", slug: "rl/chapter-5-exercises", title: "RL Chapter 5: Exercises", date: "2020-04-11", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 5-6", slug: "rl/chapter-5-monte-carlo-methods", title: "RL Chapter 5: Monte Carlo Methods", date: "2020-04-11", tags: ["Reinforcement Learning", "Notes"] },
    { slug: "teaching-machines-rules-algorithms-cellular-automata", title: "Teaching Machines Rules and Algorithms", date: "2020-04-04", tags: ["Neural Networks", "Neural Automata", "Research"] },

    // 2019
    { group: "Barto Sutton Chapter 3-4", slug: "rl/chapter-4-dynamic-programming", title: "RL Chapter 4: Dynamic Programming", date: "2019-08-25", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 3-4", slug: "rl/chapter-4-exercises", title: "RL Chapter 4: Exercises", date: "2019-08-25", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 3-4", slug: "rl/chapter-3-goals-and-rewards", title: "RL Chapter 3: Goals and Rewards", date: "2019-07-14", tags: ["Reinforcement Learning", "Notes"] },
    { slug: "how-to-read-textbooks-like-pro", title: "How to Read Textbooks like a Pro", date: "2019-05-31", tags: ["Shorts"] },
    { group: "Barto Sutton Chapter 2", slug: "rl/chapter-2-additional-topics", title: "RL Chapter 2: Additional Topics", date: "2019-05-19", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 2", slug: "rl/chapter-2-exercises", title: "RL Chapter 2: Exercises", date: "2019-05-19", tags: ["Reinforcement Learning", "Notes"] },
    { group: "Barto Sutton Chapter 2", slug: "rl/chapter-2-multi-armed-bandit", title: "RL Chapter 2: Multi-Armed Bandit", date: "2019-05-19", tags: ["Reinforcement Learning", "Notes"] },
