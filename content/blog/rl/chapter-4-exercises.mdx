...
- title: Grid for problems 4.1 - 4.3
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_1.webp
- title: Value Distribution for $p_h=0.4$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_8.webp
- title: Value Distribution for $p_h=0.25$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_9_1.webp
- title: Value Distribution for $p_h=0.55$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_9_2.webp
---
...
![Grid for problems 4.1 - 4.3](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_1.webp)
...
![Value Distribution for $p_h=0.4$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_8.webp)
...
![Value Distribution for $p_h=0.25$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_9_1.webp)

*Value Distribution for $p_h=0.25$*

![Value Distribution for $p_h=0.55$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex4_9_2.webp)
