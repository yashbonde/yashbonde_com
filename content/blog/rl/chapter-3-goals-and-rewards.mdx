...
- title: here
  url: https://drive.google.com/open?id=0B3w765rOKuKAcERUTmJaN1lJbUU
- title: A sample Markov Decision Process
  url: https://cdn-images-1.medium.com/max/800/1*rCko3p9x0rDv3v57rfckIg.png
- title: Square block represents special absorbing state
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_1.webp
- title: Example of backup diagram for $v_\pi$
  url: https://s3-ap-south-1.amazonaws.com/av-blog-media/wp-content/uploads/2018/09/im_13.png
- title: Grid World for the example 3.5
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_2.webp
- title: Golf World for the example 3.6
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_3.webp
- title: New backup diagrams for $v_*$ and $q_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/modified_backup.webp
- title: any method
  url: https://courses.lumenlearning.com/waymakercollegealgebra/chapter/methods-for-solving-a-system-of-nonlinear-equations/
- title: MDP for examples 3.3 and 3.9
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex3_3.webp
---
...
![Square block represents special absorbing state](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_1.webp)
...
![Grid World for the example 3.5](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_2.webp)
...
![Golf World for the example 3.6](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_3.webp)
...
![New backup diagrams for $v_*$ and $q_*$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/modified_backup.webp)
...
![MDP for examples 3.3 and 3.9](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex3_3.webp)
