...
- title: Square block represents special absorbing state
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_1.png
...
- title: Grid World for the example 3.5
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_2.png
- title: Golf World for the example 3.6
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap3_3.png
- title: New backup diagrams for $v_*$ and $q_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/modified_backup.png
- title: any method
...
- title: MDP for examples 3.3 and 3.9
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/ex3_3.png
---
