...
- title: Deepmind's Youtube Lecture
  url: https://www.youtube.com/watch?v=Nd1-UUMVfz4&list=PLqYmG7hTraZDM-OYHWgPebj2MfCFzFObQ&index=4&t=0s
- title: slides
  url: https://drive.google.com/file/d/0B3w765rOKuKAZWV6bGFJcWN6VDg/view?usp=sharing
- title: Tabular TD($0$) for estimating $v_\pi$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_1.webp
- title: If our aim is to predict total time then how MC would compare against TD
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_2.webp
- title: MC vs. TD
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_3.webp
- title: Performance of TD($0$) and constant-$\alpha$ MC under batch training on random
    walk task
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_4.webp
- title: Transition diagram
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_5.webp
- title: Sarsa (On-policy TD Control) for estimating $Q \approx q_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_6.webp
- title: Deepmind
...
- title: Q-Learning (Off-policy TD Control) for estimating $\pi \approx \pi_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_7.webp
- title: 'right: cliff environment setup | left: rewards by the two algorithms'
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_8.webp
- title: Interim (dashed) and Asymptotic (solid) are calculated by getting averages
    from first 10 and 50,000 runs. Solid Circle shows the best performance for interim
    performance
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_9.webp
- title: Q vs. Double-Q for the given MDP
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_10.webp
- title: Double Q-learning, for estimating $Q_1 \approx Q_2 \approx q_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_11.webp
- title: two state-action pairs make board reach the same "afterposition"
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_12.webp
---
...
![Tabular TD($0$) for estimating $v_\pi$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_1.webp)
...
![If our aim is to predict total time then how MC would compare against TD](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_2.webp)
...
![MC vs. TD](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_3.webp)
...
![Performance of TD($0$) and constant-$\alpha$ MC under batch training on random walk task](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_4.webp)
...
![Transition diagram](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_5.webp)
...
![Sarsa (On-policy TD Control) for estimating $Q \approx q_*$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_6.webp)
...
![Q-Learning (Off-policy TD Control) for estimating $\pi \approx \pi_*$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_7.webp)
...
![right: cliff environment setup | left: rewards by the two algorithms](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_8.webp)
...
![Interim (dashed) and Asymptotic (solid) are calculated by getting averages from first 10 and 50,000 runs. Solid Circle shows the best performance for interim performance](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_9.webp)
...
![Q vs. Double-Q for the given MDP](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_10.webp)
...
![Double Q-learning, for estimating $Q_1 \approx Q_2 \approx q_*$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_11.webp)
...
![two state-action pairs make board reach the same "afterposition"](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_12.webp)
