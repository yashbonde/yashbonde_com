...
- title: Tabular TD($0$) for estimating $v_\pi$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_1.png
- title: If our aim is to predict total time then how MC would compare against TD
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_2.png
- title: MC vs. TD
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_3.png
- title: Performance of TD($0$) and constant-$\alpha$ MC under batch training on random
    walk task
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_4.png
- title: Transition diagram
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_5.png
- title: Sarsa (On-policy TD Control) for estimating $Q \approx q_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_6.png
- title: Deepmind
...
- title: Q-Learning (Off-policy TD Control) for estimating $\pi \approx \pi_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_7.png
- title: 'right: cliff environment setup | left: rewards by the two algorithms'
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_8.png
- title: Interim (dashed) and Asymptotic (solid) are calculated by getting averages
    ...
    performance
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_9.png
- title: Q vs. Double-Q for the given MDP
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_10.png
- title: Double Q-learning, for estimating $Q_1 \approx Q_2 \approx q_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_11.png
- title: two state-action pairs make board reach the same "afterposition"
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap6_12.png
---
