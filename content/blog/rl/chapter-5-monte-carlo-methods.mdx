...
- title: Note the subtle difference in the two
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/FVMC-EVMC.png
- title: First Visit MC Process
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_1.png
- title: instead of $v_\pi$ we have $q_\pi$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_2.png
- title: On policy first-visit MC control (for $\epsilon$-soft policies), estimates
    $\pi \approx \pi_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_4.png
- title: For example 5.4
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_5.png
- title: For example 5.5
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_6.png
- title: Off-policy MC Prediction (policy evaluation) for estimating $Q \approx q_\pi$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_7.png
- title: Off-policy MC control for estimating $\pi \approx \pi_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_8.png
---
