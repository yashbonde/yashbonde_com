...
- title: Note the subtle difference in the two
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/FVMC-EVMC.webp
- title: First Visit MC Process
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_1.webp
- title: instead of $v_\pi$ we have $q_\pi$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_2.webp
- title: On policy first-visit MC control (for $\epsilon$-soft policies), estimates
    $\pi \approx \pi_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_4.webp
- title: For example 5.4
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_5.webp
- title: For example 5.5
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_6.webp
- title: Off-policy MC Prediction (policy evaluation) for estimating $Q \approx q_\pi$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_7.webp
- title: Off-policy MC control for estimating $\pi \approx \pi_*$
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_8.webp
---
...
![Note the subtle difference in the two](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/FVMC-EVMC.webp)

*Note the subtle difference in the two*

![First Visit MC Process](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_1.webp)
...
![instead of $v_\pi$ we have $q_\pi$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_2.webp)
...
![Monte Carlo ES (Exploring Start), for estimating $\pi \approx \pi_*$. Note that this can be improved by having [incremental averaging](./chap2.html#2_4) as [here](./chap5_ex.html#5_4)](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_3.webp)
...
![On policy first-visit MC control (for $\epsilon$-soft policies), estimates $\pi \approx \pi_*$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_4.webp)
...
![For example 5.4](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_5.webp)
...
![For example 5.5](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_6.webp)
...
![Off-policy MC Prediction (policy evaluation) for estimating $Q \approx q_\pi$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_7.webp)
...
![Off-policy MC control for estimating $\pi \approx \pi_*$](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/rl/chap5_8.webp)
