...
- title: slides here
  url: https://petar-v.com/talks/Algo-WWW.pdf
- title: linkedin
  url: https://www.linkedin.com/in/yash-bonde/
- title: twitter
  url: https://twitter.com/bondebhai/
- title: Pitfalls of Graph Neural Network Evaluation (Schur et al.)
  url: http://arxiv.org/abs/1811.05868
- title: The above two are screenshots from this paper
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-1.png
- title: The above two are screenshots from this paper
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-2.png
- title: On Graph Classification Networks, Datasets and Baselines (Luzhnica et al.)
  url: http://arxiv.org/abs/1905.04682
- title: Simple baseline models
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-3.png
- title: The above two are screenshots from this paper
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-4.png
- title: Simplifying Graph Convolutional Networks (Wu et al.)
  url: http://arxiv.org/abs/1902.07153
- title: from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-5.png
- title: from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-6.png
- title: credit assignment
  url: https://ai.stackexchange.com/questions/12908/what-is-the-credit-assignment-problem
- title: from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-11.png
- title: An Efficient Graph Convolutional Network Technique for the Travelling Salesman
    Problem (Joshi et al.)
  url: http://arxiv.org/abs/1906.01227
- title: Neural Turing Machine (NTM) on copy task, from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-9.png
- title: NTM vs. LSTM on repeat-copy task, from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-8.png
- title: Prim's Algorithm
  url: https://en.wikipedia.org/wiki/Prim%27s_algorithm
- title: Dijkstra's algorithm
  url: https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm
- title: from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-7.png
- title: Looking at NAE from conventional programming paradigm, these are the 3 papers
    discussed below
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-10.png
- title: What can Neural Networks Reason About? (Xu et al.)
  url: https://openreview.net/forum?id=rJxbJeHFPS
- title: Different types of problems with different logic required
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-12.png
- title: Deep Sets
  url: https://arxiv.org/pdf/1703.06114
- title: What the framework shows
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-14.png
- title: The above three images are from this paper
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-13.png
- title: Neural Execution of Graph Algorithms (Veličković et al.)
  url: https://openreview.net/forum?id=SkgKO0EtvS
- title: Neural Execution of Graph Algorithms
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-15.png
- title: Neural Execution of Graph Algorithms results
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-16.png
- title: Neural Execution of Graph Algorithms results
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-17.png
- title: Neural Execution of Graph Algorithms curriculum learning
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-18.png
- title: Conditional Mutual Information
  url: https://www.sciencedirect.com/topics/computer-science/shannon-information-theory
- title: Neural Execution Engines (Yan et al.)
  url: https://openreview.net/forum?id=rJg7BA4YDr
- title: Seq2Seq style sorting when trained on sequences upto length 8. Thing to note
    is that despite heavy modifications the vanilla transformer is not really doing
    anything good.
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-19.png
- title: Attention visualization
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-20.png
- title: Subroutine Level Traces in Selection Sort.
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-21.png
- title: Recursive Subroutine in Merge Sort.
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-22.png
- title: Djikstra's Algorithm to NEE Architecture.
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-23.png
- title: Model shows understanding of the number system
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-24.png
- title: Model showed unparalled results by learning what to actually do. All seven
    images above are from here
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-25.png
- title: (link)
  url: https://arxiv.org/pdf/1903.03894.pdf
- title: (link)
  url: https://arxiv.org/pdf/1511.08228.pdf
- title: (link)
  url: https://arxiv.org/pdf/1511.06392.pdf
- title: (link)
