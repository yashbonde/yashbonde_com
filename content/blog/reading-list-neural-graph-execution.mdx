...
ogImage: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/images/sf-tiny.webp
...
- Notes
references:
- title: 'Graves 2014, Neural Turing Machines'
  url: https://arxiv.org/abs/1410.5401
- title: 'Kurach and Andrychowicz 2015, N-Random access machine'
  url: https://arxiv.org/abs/1511.06392.pdf
- title: 'Kaiser & Sutskever 2016, Neural GPU is a faster parallelised version of NTM'
  url: https://arxiv.org/abs/1511.08228.pdf
- title: 'Shchur 2018, Pitfalls of Graph Neural Network Evaluation'
  url: http://arxiv.org/abs/1811.05868
- title: 'Veličković 2019, Deep Graph Infomax'
  url: https://arxiv.org/abs/1809.10341
- title: 'Wu 2019,Simplifying Graph Convolutional Network'
  url: http://arxiv.org/abs/1902.07153
- title: 'Ying 2019, GNNExplainer: Generating Explanations for Graph Neural Networks'
  url: https://arxiv.org/abs/1903.03894.pdf
- title: 'Luzhnica 2019, On Graph Classification Networks, Datasets and Baselines'
  url: http://arxiv.org/abs/1905.04682
- title: 'Xu 2019, What Can Neural Networks Reason About?'
  url: https://arxiv.org/abs/1905.13211
- title: 'Joshi 2019, An Efficient Graph Convolutional Network Technique for the Travelling Salesman Problem'
  url: http://arxiv.org/abs/1906.01227
- title: 'Veličković 2019, Neural Execution of Graph Algorithms'
  url: https://arxiv.org/abs/1910.10593
- title: 'Yan 2020, Neural Execution Engines'
  url: https://arxiv.org/abs/2006.08084
- title: "Petar's talk on the neural algorithm execution"
  url: https://www.youtube.com/watch?v=IPQ6CPoluok
- title: credit assignment
  url: https://ai.stackexchange.com/questions/12908/what-is-the-credit-assignment-problem
- title: Prim's Algorithm
  url: https://en.wikipedia.org/wiki/Prim%27s_algorithm
- title: Dijkstra's algorithm
  url: https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm
- title: Conditional Mutual Information
  url: https://www.sciencedirect.com/topics/computer-science/shannon-information-theory
...
### Index
- [Why do this when I have Algorithms?](#why-do-this-when-i-have-algorithms)
- [Issues with Datasets, Models (Benchmarking GNNs)](#issues-with-datasets-models-benchmarking-gnns)
- [From Generalisation point (Strong Generalisation)](#from-generalisation-point-strong-generalisation)
- [Reusing Subroutines (Multitask Learning)](#reusing-subroutines-multitask-learning)
- [Problem Solving in Hierarchy of Control (Discovering Algorithms)](#problem-solving-in-hierarchy-of-control-discovering-algorithms)
- [Conclusion](#conclusion)
- [Total Reading List](#total-reading-list)
...
![The above two are screenshots from this paper](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-1.webp)

![The above two are screenshots from this paper](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-2.webp)
...
![Simple baseline models](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-3.webp)

Now going over the benchmark comparisons we see that majority cases the GNN models perform worse to MLP (blue).

![The above two are screenshots from this paper](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-4.webp)
...
![from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-5.webp)
...
![from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-6.webp)
...
Popular GNN benchmark datasets often unreliable and the complexity not very high. Training the networks on algorithms might prove to be favourable as we can generate infinite data, perform complex data manipulation and we get that a very clear hierarchy of models emerge (discussed [later](#problem-solving-in-hierarchy-of-control-discovering-algorithms)). Since we use a generating function we do not have noise in the data generated and [credit assignment](https://ai.stackexchange.com/questions/12908/what-is-the-credit-assignment-problem) becomes easier.

![from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-11.webp)
...
![Neural Turing Machine (NTM) on copy task, from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-9.webp)
...
![NTM vs. LSTM on repeat-copy task, from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-8.webp)

[Later](#problem-solving-in-hierarchy-of-control-discovering-algorithms) we will see how generalisation can be achieved on NAE and use that to achieve 100% on much different evaluation cases.
...
![from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-7.webp)
...
![Looking at NAE from conventional programming paradigm, these are the 3 papers discussed below](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-10.webp)

The idea is to breakdown the execution into three levels, similar to how the conventional programming is broken down. The higher up you go you get more abstract tasks and things that reason at a much higher level. And the lower you go, you get closer to metal more basic operations. In the following subsections I discuss all the three papers, [**What can Neural Networks Reason About? (Xu et al.)**](#what-can-neural-networks-reason-about-xu-et-al),
...
![Different types of problems with different logic required](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-12.webp)
...
![What the framework shows](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-14.webp)
...
![The above three images are from this paper](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-13.webp)
...
![Neural Execution of Graph Algorithms](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-15.webp)
...
![Neural Execution of Graph Algorithms results](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-16.webp)

![Neural Execution of Graph Algorithms results](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-17.webp)
...
![Neural Execution of Graph Algorithms curriculum learning](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-18.webp)
...
![Seq2Seq style sorting when trained on sequences upto length 8. Thing to note is that despite heavy modifications the vanilla transformer is not really doing anything good.](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-19.webp)
...
![Attention visualization](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-20.webp)
...
![Subroutine Level Traces in Selection Sort.](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-21.webp)

![Recursive Subroutine in Merge Sort.](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-22.webp)

![Djikstra's Algorithm to NEE Architecture.](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-23.webp)
...
![Model shows understanding of the number system](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-24.webp)

![Model showed unparalled results by learning what to actually do. All seven images above are from here](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/nae-25.webp)
