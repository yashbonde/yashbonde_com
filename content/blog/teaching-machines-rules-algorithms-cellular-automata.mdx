...
- title: Covid-19 Kaggle challenge
  url: https://www.kaggle.com/allen-institute-for-ai/CORD-19-research-challenge
- title: An overview of how the business rules, you can look at the complexity that
    they have and ignoring the data flow piece there is a possibility to convert this
    into Neural Engine
  url: https://www.researchgate.net/profile/Rainer_Endl/publication/225116605/figure/fig1/AS:671510029144090@1537111875988/Business-rules-as-integration-layers.png
- title: Flow-based programing
  url: https://jpaulm.github.io/fbp/
- title: Differentiable Neural Computers
  url: https://deepmind.com/blog/article/differentiable-neural-computers
- title: Dijkstra's Algorithm
  url: https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm
- title: Conway's Game of Life
  url: https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life
- title: starting top right go line by line
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_0.webp
- title: this colab notebook
  url: https://colab.research.google.com/drive/1-Sw3jxWj4KOrZXBmCuKENUhuVr-hiSfT
- title: 'Quick training result left: target, right: predicted'
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_1.webp
- title: Surprisingly there is no change on results and in fact it performs better
    on larger grid sizes
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_2.webp
- title: 'And no it is not over-fitting to give just one value; left: target, right:
    predicted'
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_3.webp
- title: Though there is decline in performance when 1s occur too frequently its still
    above 95% mark
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_4.webp
- title: 'Edge cases are still tricky, pun intended; left: target, right: predicted'
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_5.webp
- title: 'Though it has the correct idea of where to look for it does not generate
    the proper result; left: target, right: predicted'
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_6.webp
---

🦠 This particular Coronavirus strain [(SARS Cov2)](https://en.wikipedia.org/wiki/Severe_acute_respiratory_syndrome_coronavirus_2) is the biggest calamity to happen to humanity since World War 2. It has put all of us in our homes without anything interesting to do, so I decided to take time and try out some whacky ideas. But being limited by compute power of a Google Colab I needed to try out something simple, quick and low power, not training some giant neural network based language model for [Covid-19 Kaggle challenge](https://www.kaggle.com/allen-institute-for-ai/CORD-19-research-challenge).
...
![starting top right go line by line](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_0.webp)
...
![Quick training result left: target, right: predicted](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_1.webp)
...
![Surprisingly there is no change on results and in fact it performs better on larger grid sizes](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_2.webp)

![And no it is not over-fitting to give just one value; left: target, right: predicted](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_3.webp)
...
![Though there is decline in performance when 1s occur too frequently its still above 95% mark](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_4.webp)

![Edge cases are still tricky, pun intended; left: target, right: predicted](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_5.webp)
...
![Though it has the correct idea of where to look for it does not generate the proper result; left: target, right: predicted](https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/CA_6.webp)
