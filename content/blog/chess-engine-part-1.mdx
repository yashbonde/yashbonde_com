...
- title: Training method (left) and network (right) of AlphaGo. Note how is utilises
  ...
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/chess-lm-0.png
- title: video
...
- title: Sample sequences shuffled. Note 0 means new game just like GPT-2 and not
  ...
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/chess-lm-2.png
- title: Tensorboard for training 3 models. Grey represents buffer size of 55555,
  ...
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/chess-lm-3.png
- title: ELO ratings
