...
references:
- title: post
  url: https://towardsdatascience.com/call-for-an-army-of-be-a-sts-f751436671be
- title: another
  url: https://towardsdatascience.com/lets-go-over-few-things-freeciv-1d400969ad3e
- title: repo
  url: https://github.com/yashbonde/python-interfaces
- title: main repo
  url: https://github.com/freeciv/freeciv
- title: packets
  url: https://github.com/freeciv/freeciv/blob/master/common/networking/packets.def
- title: Freeciv Package Structure
  url: https://ndotovhaihcfvwintgpc.supabase.co/storage/v1/object/public/yashbonde/old/freeciv01.svg
- title: LinkedIn
