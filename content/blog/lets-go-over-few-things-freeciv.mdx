...
- Freeciv
references:
- title: freeciv learning environment
  url: https://github.com/yashbonde/freeciv-python
- title: Self driving car operates in the continuous distribution
  url: https://miro.medium.com/max/1400/1*PGimsPTRnFuWOQxQBgovWg.jpeg
- title: Montezuma's Revenge is an Atari game with discrete action space. This also
    happens to be a notoriously difficult game for AI to master due to its sparse
    reward structure.
  url: https://miro.medium.com/max/1400/1*uPvKP67o4Al_b-yjPqtPWQ.jpeg
- title: The game at turn 314 is so advanced, though the game in 'default' mode can
    run to 5000 turns. The small circles at the bottom show the actions that can be
    takes for any unit. 12 actions can be taken for this particular unit, 1 less than
    the Atari games! This is an amazing example of the vastness of this game.
  url: https://miro.medium.com/max/2626/1*xgiFUnv2Gg63fkAiz9XaCg.jpeg
- title: technology tree
  url: http://freeciv.wikia.com/wiki/Technology
- title: A sample tech-tree in freeciv. As you can see in the right, to get Electricity,
    you need to have Metallurgy and Magnetism. This complex intermixing of possibilities
    make life tricky for our small agent.
  url: https://miro.medium.com/max/2858/1*52mzxyJLZ_6nWPIVJI-dmQ.png
- title: A sample city, more details about the cities here
  url: https://miro.medium.com/max/1020/1*lEiKvSM0wFeI0EfOTPwtqA.png
- title: score
  url: http://freeciv.wikia.com/wiki/Score
- title: Look at the minimap at bottom left, the opportunity to see how various AIs
    will compete with each other is one thing that really excites me about this!
  url: https://miro.medium.com/max/3168/1*5mejAWAMR-QdwdfFczB5_w.jpeg
- title: Diplomacy
  url: http://freeciv.wikia.com/wiki/Diplomacy
- title: competitive self-play
  url: https://blog.openai.com/competitive-self-play/
